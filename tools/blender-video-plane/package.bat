...
REM Package script for the Cab87 Video Plane Blender add-on.
REM Builds a versioned zip from the nested cab87_video_plane_tool add-on folder.

cd /d "%~dp0"

set "SCRIPT_DIR=%~dp0"
set "ADDON_DIR=cab87_video_plane_tool"
