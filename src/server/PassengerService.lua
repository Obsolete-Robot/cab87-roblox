...
local function createPassengerStops(world, driveSurfaces, spawnPose, rng)
	local stops, folder, surfaceRaycastParams = PassengerStopService.createPassengerStops({
		world = world,
...
rebuildPassengerStops = function(service)
	...
	service.stops, service.stopFolder, service.surfaceRaycastParams = createPassengerStops(
		service.world,
